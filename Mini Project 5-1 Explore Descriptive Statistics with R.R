...
#epa_data <- read.csv("c4_epa_air_quality.csv", stringsAsFactors = FALSE)
...
#    YOUR ANSWER: Air Quality Index. Scale of how poluted the air is.
...
#    YOUR ANSWER: Unitless index. Corresponds ot air pollution levels
...
#    YOUR ANSWER: 260 counts/regions
...
#    YOUR ANSWER: 25% are at 2 or below
...
#    YOUR ANSWER: 25% is at 9 or above
...
#    YOUR ANSWER: Frequency of each state, unique states. 
...
#    YOUR ANSWER: gives general look at what air quality looks like in the US.
...
#    YOUR ANSWER: central tendency of the US for air quality.
...
#    YOUR ANSWER: best air quality in the US
...
#     YOUR ANSWER: Worst air quality in the US
...
#     YOUR ANSWER: How spread apart the values are between states, more variability.
...
#     YOUR ANSWER: How to get descriptive statistics in R. What are measures of central tendency and spread
...
#     YOUR ANSWER: Show how the AQI is spread and present states that are the worst for air quality and that need to be addressed.
...
#     YOUR ANSWER: I would tell them that the max AQI value in the U.S. is 50 which is at an acceptable level considered by the EPA.
